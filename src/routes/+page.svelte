...
<div class="relative w-full">
	...
	<Inview>
		<div class="absolute bottom-15 left-5 md:bottom-20 md:left-25">
			<h1 class="text-base font-bold text-secondary drop-shadow-lg md:mb-5 md:text-4xl">
				稻町設計
			</h1>
...
<Inview>
	<div class="relative m-0 w-full text-center md:mt-20 md:mb-20">
		...
		{/if}
		<p
			class="absolute top-1/2 left-1/2 w-[80vw] -translate-1/2 border border-solid border-secondary p-5 text-sm text-secondary md:relative md:top-auto md:left-auto md:m-auto md:w-[60vw] md:translate-none md:border-paragraph md:p-20 md:pt-10 md:pb-10 md:text-base md:text-paragraph"
		>
...
<Inview>
	<div class="relative m-0 md:mt-25 md:mb-25 md:flex md:justify-between">
		...
		>
			<Inview>
				<button
					class="text-base font-bold text-secondary drop-shadow-lg md:mb-5 md:border md:border-paragraph md:p-20 md:pt-5 md:pb-5 md:text-xl md:text-primary md:drop-shadow-none"
					>專案作品</button
				>
				<hr
					class="my-2 w-[80vw] border border-secondary md:mb-5 md:w-[40vw] md:border md:border-paragraph"
				/>
				<p
					class="m-auto w-[79.5vw] text-sm text-secondary drop-shadow-lg md:mb-5 md:w-[35vw] md:text-base md:text-paragraph md:drop-shadow-none"
				>
