...
<Inview>
	<div class="m-auto mt-10 mb-10 hidden w-[90vw] text-center md:block">
		<h1 class="mb-3 text-center text-2xl font-bold text-secondary">關於我們</h1>
...
<div class="relative m-0 block w-full md:flex md:items-center md:justify-around md:p-20">
	...
	<div
		class="absolute top-1/2 left-1/2 m-auto w-[75vw] -translate-1/2 p-0 md:relative md:top-auto md:left-auto md:flex md:h-[60vh] md:w-[40vw] md:translate-none md:items-center md:justify-center md:rounded-2xl md:bg-block"
	>
		<Inview>
			<p class="text-sm text-mb md:p-20 md:text-base md:text-secondary">
