	...
	>
		<Inview>
			...
			<img
				src={signature}
				alt="Signature"
				class="m-auto mt-10 h-auto w-40 border p-10 pt-0 pb-0 hue-rotate-180 invert saturate-200 sepia filter
         md:absolute md:right-10 md:bottom-0 md:m-0 md:w-60 md:translate-y-55 md:transform md:border-none md:p-0 md:filter-none
         md:dark:border-none md:dark:hue-rotate-180 md:dark:invert md:dark:saturate-200 md:dark:sepia md:dark:filter"
			/>
		</Inview>
	</div>
</div>
